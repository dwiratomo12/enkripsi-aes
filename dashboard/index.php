    ...
    <?php include('navmenu.php'); ?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-home"></i> Aplikasi Dekripsi Enkripsi Gambar dengan <b>(AES)</b></h1>
          </div>
          <div>
            <ul class="breadcrumb">
              ...
              <li><a href="#">Beranda</a></li>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="widget-small danger"><i class="icon fa fa-thumbs-o-up fa-3x"></i>
                      <?php
        ...
        <div class="row" >
          <div class="col-md-12" >
          <div class="card" style="background-color: #f1a417;">
            <div class="card-body">
          <center><img src="../assets/images/aes.png" alt="" class="img-responsive" width="100px">
        <h3>AES-128</h3>
        <p style="color:#e7e7e7;">Aplikasi Enkripsi Dekripsi Gambar Menggunakan Algoritma Advanced Encryption Standard (AES-128 bit).</p>
        <p style="color:#e7e7e7;">Format file yang didukung untuk di enkripsi adalah jpg,jpeg,png,dan jfif</p>
